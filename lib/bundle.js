...
$('.buttons #year').click(function () {
  return $('body, html').animate({ scrollTop: $('.year').offset().top }, "slow");
});
$('.buttons #map').click(function () {
  return $('body, html').animate({ scrollTop: $('.map').offset().top }, "slow");
});
$('.buttons #sunburst').click(function () {
  return $('body, html').animate({ scrollTop: $('.sunburst').offset().top }, "slow");
});
$('.top').click(function () {
...
var renderYear = exports.renderYear = function renderYear(idx) {
  ...
  d3.csv('./lib/year.csv', function (d) {
    ...
    barEnter.enter().append('rect').attr('class', 'bar').attr('id', function (d) {
      ...
      return y(d.Total);
    }).attr('width', x.bandwidth()).attr('height', i ? function (d) {
      return innerHeight - y(d.Total);
    } : 0).call(i ? null : transition);
    ...
    barEnter.selectAll('.bar').on('click', function (d) {
    ...
    barEnter.selectAll('text').data(data).enter().append('text').attr('class', 'bar-text').attr('x', function (d) {
